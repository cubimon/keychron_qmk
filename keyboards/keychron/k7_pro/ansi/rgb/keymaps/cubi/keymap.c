...
[CUBI_BASE] = LAYOUT_ansi_68(
     ...
     LSFT_T(KC_ESC),         KC_Z,     KC_X,   KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  LSFT_T(KC_DOT),  LCTL_T(KC_SLSH),                           KC_RSFT, KC_UP,   KC_PGDN,
     KC_LCTL, KC_LOPTN,      KC_LCMMD,                             KC_SPC,                                 KC_RCMMD,        MO(MAC_FN1),     MO(FN2),                  KC_LEFT, KC_DOWN, KC_RGHT),
...
[CUBI_SYMBOL] = LAYOUT_ansi_68(
     ...
     KC_TRNS,  MO(CUBI_FUNCTION), KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_KP_4,  KC_KP_5,  KC_KP_6,  KC_KP_0,  KC_TRNS,            KC_TRNS,            KC_TRNS,
